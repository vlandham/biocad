package
{
	 ...
	 */
	public class StaggeredCircleLayout extends Layout
	{	
		...
		protected var _stagger:Number = 15;
		 ...
		 */
		public function StaggeredCircleLayout(
		...
		{			
			...
			if (_rBinding.property) {
				...
				visitor = function(n:NodeSprite):void {
					...
					_t.$(n).radius = (_inner + f * dr) + _stagger;
					_stagger= _stagger*-1;
				};
			} else if (treeLayout) {
